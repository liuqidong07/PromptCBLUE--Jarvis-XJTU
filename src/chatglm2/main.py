...
from src.chatglm2.trainer_seq2seq import Seq2SeqTrainer
from src.chatglm2.arguments import ModelArguments, DataTrainingArguments

from src.chatglm2.peft import PeftModel, LoraConfig, TaskType, get_peft_model
...
def main(parser):
    ...
    prefix = data_args.source_prefix if data_args.source_prefix is not None else "" # add prefix prompt, but always None
    ...
    if training_args.do_train:
        ...
        with training_args.main_process_first(desc="train dataset map pre-processing"):
            train_dataset = train_dataset.map(
                ...
                batched=True,
                num_proc=data_args.preprocessing_num_workers,   # num workers to preprocess the data
    ...
    if training_args.do_train:
        ...
        #model.supports_gradient_checkingpoints = True  # save the cuda
